      ...
      <form method="post" action="{{route('datas.store')}}">
        @csrf
          ...
          <div class="mb-3">
              ...
              <input type="color" name="color" class="form-control form-control-color @if($errors->has('color')) {{'is-invalid'}} @endif" style="width: 100px; height: 100px;" value="{{ old('color') }}" title="Choose your color">
              @if($errors->has('color'))
